...
#include "btl_storage_spiflash_configs.h"
...
static StorageSpiflashDevice_t getDeviceType(void)
{
  ...
  switch (mfgId) {
    case MFG_ID_TSINGTENG:
      switch (deviceId) {
#if defined(BTL_STORAGE_SPIFLASH_TSINGTENG_TS25Q80UA) && (BTL_STORAGE_SPIFLASH_TSINGTENG_TS25Q80UA == 1)
        case DEVICE_ID_TSINGTENG_8M:
          return TSINGTENG_8M_DEVICE;
#endif
        default:
