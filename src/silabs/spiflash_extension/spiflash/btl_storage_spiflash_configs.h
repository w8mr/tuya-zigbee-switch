...
#if defined(BTL_STORAGE_SPIFLASH_TSINGTENG_DEVICES)
/// Support Tsingteng TS25Q80UA
...
#if (BTL_STORAGE_SPIFLASH_TSINGTENG_TS25Q80UA == 1)
/// Information for Tsingteng TS25Q80UA
static const BootloaderStorageImplementationInformation_t tsingteng8MInfo = {
  BOOTLOADER_STORAGE_IMPL_INFO_VERSION,
  (BOOTLOADER_STORAGE_IMPL_CAPABILITY_ERASE_SUPPORTED
   | BOOTLOADER_STORAGE_IMPL_CAPABILITY_PAGE_ERASE_REQUIRED),
  TIMING_ERASE_4K_MAX_MS,
